$(document).ready(function () {
  ...
  if ($("#bac-form-wrapper-new").length) {
    ...
    // Hide commercial collection type note
    $("#commercial-collection-type-note-text").hide();
    // Show residential item collection note and hide commercial item collection note
    $("#residential-item-collection-note-text").show();
    $("#commercial-item-collection-note-text").hide();
    // Show elements with class .body2.forest-green.opacity-70.pricing
    $(".body2.forest-green.opacity-70.pricing").show();
    // Show shipping note wrapper
    $("#shipping-note-wrapper").show();
    ...
    $("#com-form-button").click(function () {
      ...
      // Show commercial collection type note
      $("#commercial-collection-type-note-text").show();
      // Show commercial item collection note and hide residential item collection note
      $("#commercial-item-collection-note-text").show();
      $("#residential-item-collection-note-text").hide();
      // Hide elements with class .body2.forest-green.opacity-70.pricing
      $(".body2.forest-green.opacity-70.pricing").hide();
      // Hide shipping note wrapper
      $("#shipping-note-wrapper").hide();
    ...
    // only reflow dropdowns when the window WIDTH really changes
    ...
    $(window).on("resize", function () {
      ...
      if (newWidth !== lastWindowWidth) {
        ...
        itemDropdownCalculation();
        // re-open any dropdowns that were rotated
        $(".form-product-dropdown-title").each(function () {
          const $icon = $(this).find(".form-field-icon.right");
        ...
        orderLines.forEach(function (line) {
          ...
          $(".form-product-option").each(function () {
            ...
            if (itemNameElement === itemName) {
              ...
              var existingQuantity = parseInt($(this).find(".quantity").text());
              var totalQuantity = existingQuantity + quantity;
              $(this).find(".quantity").text(totalQuantity);
              updateCounterButtons($(this).find(".quantity"));
            }
          });
        });
